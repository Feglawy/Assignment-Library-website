...
class SignupForm(UserCreationForm):
    ...
    class Meta:
        ...
        widgets = {
            'first_name': forms.TextInput(attrs={'class': 'input', 'id': 'first-name-inp', 'placeholder': 'First name'}),
            ...
            'password1': forms.PasswordInput(attrs={'class': 'input', 'id': 'inp-pass', 'placeholder': 'Enter your password'}),
            'password2': forms.PasswordInput(attrs={'class': 'input', 'id': 'confirm-inp-pass', 'placeholder': 'Confirm your password'}),
        }
